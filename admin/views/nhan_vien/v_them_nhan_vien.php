  ...
  <form method="post" enctype="multipart/form-data">
    <fieldset>
      ...
      <p>
        ...
        <input class="text-input small-input kiemtra" data_error="Nhập tên nhân viên" type="text" id="ten_nhan_vien" name="ten_nhan_vien" />
      </p>
      <p>
        <label>Địa chỉ</label>
        <textarea name="dia_chi" cols="50" rows="3" class="text-input textarea wysiwyg " id="medium-input" ></textarea>
      </p>
      <p>
      ...
      <p>
        ...
        <input class="button" type="button" value="Bỏ qua" onclick="window.location='danh_sach_nhan_vien.php'" />
      </p>
    </fieldset>
    <div class="clear"></div>
    <!-- End .clear -->
