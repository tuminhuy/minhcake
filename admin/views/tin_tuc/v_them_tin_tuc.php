  ...
  <form method="post" enctype="multipart/form-data">
    <fieldset>
      <p>
        ...
        <input class="text-input small-input kiemtra" data_error="Nhập tiêu đề tin tức" type="text" id="ten_tin_tuc" name="ten_tin_tuc" />
      </p>
      <p>
      ...
      <p>
        ...
        <input class="text-input small-input datepicker" type="date" id="ngay_dang_tin" name="ngay_dang_tin" />
      </p>
      <p>
