  ...
  <form method="post" enctype="multipart/form-data">
    <fieldset>
      <p>
        ...
        <select class="text-input small-input kiemtra" data_error="Chọn tên chủ đề" id="ma_chu_de" name="ma_chu_de" >
          <?php
      ...
      <p>
        ...
        <textarea name="noi_dung_chi_tiet" cols="50" rows="5" class="text-input large-input ckeditor" id="noi_dung_chi_tiet"></textarea>
      </p>
      <p>
        <label>Số lượng</label>
        <input class="text-input small-input kiemtra" data_error="Nhập số lượng sản phẩm" type="text" id="so_luong" name="so_luong" />
      </p>
      <p>
      ...
      <p>
        <label>Đơn giá</label>
        <input class="text-input small-input kiemtra" data_error="Nhập đơn giá sản phẩm" type="text" id="don_gia" name="don_gia" />
      </p>
      <p>
        <label>Ngày thêm sản phẩm</label>
        <input class="text-input small-input datepicker" type="date" id="ngay_them_san_pham" name="ngay_them_san_pham" />
      </p>
      <p>
